...
(function() {
  ...
  window.showPWABanner = function() {
    ...
    style.textContent = [
      '#pwa-install-banner{position:fixed;bottom:0;left:0;right:0;z-index:9999;background:#1A1A2E;border-top:3px solid #0EA5E9;padding:14px 16px;display:flex;align-items:center;gap:12px;box-shadow:0 -4px 20px rgba(0,0,0,0.3);animation:slideUp 0.3s ease}',
      ...
      '.pwa-btn-install{background:#0EA5E9;color:#fff;border:none;border-radius:8px;padding:8px 18px;font-size:0.88rem;font-weight:700;cursor:pointer;white-space:nowrap;flex-shrink:0}',
    ...
    banner.innerHTML = '<div class="pwa-banner-icon">🖼️</div>' +
      '<div class="pwa-banner-text">' +
        '<strong>WooaImage 바로가기 추가</strong>' +
